...
import iconFornecedores from "../../assets/icons8-fornecedor-64.png"
...
export function ListagemFornecedores()
{
  ...
  return(
    ...
    <Container>
      ...
      <Header title={<h1>Listagem de Fornecedores</h1>} img={iconFornecedores}>
      ...
      <ContentMainList setPlace={"Pesquise pelo nome do fornecedor"} lista={"fornecedores"}/>
